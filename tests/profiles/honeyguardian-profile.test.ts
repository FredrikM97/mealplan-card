...
describe('honeyguardianProfile encoding/decoding', () => {
  ...
  it('throws on invalid base64', () => {
    expect(() => decodeMealPlanData('!@#$', { encodingFields: honeyguardianProfile.encodingFields! })).toThrow();
  });
  ...
  it('decodes Honeyguardian base64 (minimal)', () => {
    ...
    const result = decodeMealPlanData(base64, { encodingFields: honeyguardianProfile.encodingFields ?? [] });
